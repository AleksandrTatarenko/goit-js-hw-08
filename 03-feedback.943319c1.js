...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const a={form:document.querySelector(".feedback-form"),input:document.querySelector(".feedback-form input"),textarea:document.querySelector(".feedback-form textarea")},r={};function o(e){console.log(e.target.name),console.log(e.target.value),r[e.target.name]=e.target.value,localStorage.setItem("feedback-form-state",JSON.stringify(r))}function n(){const e=localStorage.getItem("feedback-form-state"),t=JSON.parse(e);t&&(a.input.value=t.email||"",a.textarea.value=t.message||"")}function u(e){console.log(r),e.preventDefault(),e.currentTarget.reset(),localStorage.removeItem("feedback-form-state")}a.form.addEventListener("input",(0,e.default)(o,500)),a.form.addEventListener("submit",u),n();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.943319c1.js.map