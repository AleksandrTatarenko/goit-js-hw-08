...
"use strict";var e=t(require("lodash/throttle"));function t(e){return e&&e.__esModule?e:{default:e}}const o={form:document.querySelector(".feedback-form"),input:document.querySelector(".feedback-form input"),textarea:document.querySelector(".feedback-form textarea")},a={};function r(e){console.log(e.target.name),console.log(e.target.value),a[e.target.name]=e.target.value,console.log[a],localStorage.setItem("feedback-form-state",JSON.stringify(a))}function n(){const e=localStorage.getItem("feedback-form-state"),t=JSON.parse(e);t&&(o.input.value=t.email,o.textarea.value=t.message,console.log(t))}function l(e){e.preventDefault(),e.currentTarget.reset(),localStorage.removeItem("feedback-form-state")}o.form.addEventListener("input",(0,e.default)(r,500)),o.form.addEventListener("submit",l),n();
},{"lodash/throttle":"Ywd4"}]},{},["TTyb"], null)
//# sourceMappingURL=/goit-js-hw-08/03-feedback.28c804a4.js.map